...
export class Renderer extends BaseRenderer {
    ...
    async initialize() {
        ...
        const codePerFragment = await fetch('blinphongPerFragment.wgsl').then(response => response.text());
        const codePerVertex = await fetch('blinphongPerVertex.wgsl').then(response => response.text());
    ...
    render(scene, camera) {
        ...
        this.device.queue.writeBuffer(lightUniformBuffer, 48, new Float32Array([lightComponent.directivity, lightComponent.beamWidth]));
