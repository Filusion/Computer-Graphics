...
export class Renderer extends BaseRenderer {
    ...
    async initialize() {
        ...
        const codePerFragment = await fetch('test5/nekiPerFragment.wgsl').then(response => response.text());
        const codePerVertex = await fetch('test5/nekiPerVertex.wgsl').then(response => response.text());
